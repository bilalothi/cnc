...
public class MessageController {
     ...
     *
     * @param deviceId device Id for the messages to be searched
     * @return Map containing the messages searched
     */
    @RequestMapping(value = "/searchByDeviceId", method = RequestMethod.GET)
    @ResponseBody
    public Map<String, Object> findByDeviceId(@RequestParam("messageDeviceIdSearchParam") String deviceId) {
     ...
     *
     * @param messageType type of messages to be searched
     * @param startDate start date as lower limit of search
     * @param endDate end date as upper limit of search
     * @return Map containing the messages searched
     */
