...
public class MessageProcessingService {
	 ...
	 *            Message received from the sensor in raw form
	 */
	@Transactional(readOnly = false)
	public void processAndSendMessage(String consumedMessage) {

		// 11:26:P:0099:1:A:03
		// Network ID : Device ID : Device Type : Mac Add : Battery Msg :
		// Message
		// Type : PDU
		...
		/**************************** ALERT RECEIVED *****************************************/
		else if (messageType.equals(MessageType.ALERT.getCode())) {
			...
			// Device Exists
				...
				else if (alertType.equals(AlertType.VIBRATION.getCode())
				...
				else if (alertType.equals(AlertType.VIDEO_DETECTION.getCode()) || alertType.equals(AlertType.VIDEO_DETECTION1.getCode())) {
					message.setMessageContent(finalMessage.append(" -- Video detection ").append(AT_SENSOR_MESSAGE).append(deviceId).toString());
				}

				else if (alertType.equals(AlertType.MICROWAVE.getCode())|| alertType.equals(AlertType.MICROWAVE1.getCode())) {
		...
		/**************************** LOCATION MESSAGES *****************************************/
		else if (messageType.equals(MessageType.LOCATION.getCode())) {
		...
		/**************************** STATUS MESSAGES *****************************************/
		else if (messageType.equals(MessageType.STATUS.getCode())) {
			...
			} else if (statusType.equals(StatusType.OFF.getCode())) {
				if (!deviceExists) {
			...
			} else if (statusType.equals(StatusType.SLEEP.getCode())) {
			...
			} else if (statusType.equals(StatusType.DEBUG.getCode())) {
		...
		// here.
		else if (messageType.equals(MessageType.BATTERY.getCode())) {
			if (!deviceExists) {
				finalMessage.append(WITH_DEVICE_MESSAGE).append(deviceId).append(DOES_NOT_EXIST_MESSAGE).append(DISCARD_MESSAGE);
			} else {
		...
		else if (messageType.equals(MessageType.SENSITIVITY.getCode())) {
			if (!deviceExists) {
				finalMessage.append(WITH_DEVICE_MESSAGE).append(deviceId)
						.append(DOES_NOT_EXIST_MESSAGE).append(DISCARD_MESSAGE);
			} else {
		...
		else if (messageType.equals(MessageType.LINK_QUALITY.getCode())) {
			if (!deviceExists) {
		...
		else if (messageType.equals(MessageType.SIGNAL_STRENGTH.getCode())) {
			if (!deviceExists) {
				finalMessage.append("Device with id: ").append(deviceId)
						.append(DOES_NOT_EXIST_MESSAGE).append(DISCARD_MESSAGE);
			} else {
	 ...
	 * 
	 * @param consumedMessage
	 *            Message received from the device in the form of a comma
	 *            separated string
	 * 
	 */
